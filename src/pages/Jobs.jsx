        ...
        <DataCard title="No Missions">
          <div className="text-center py-4 space-y-2">
            ...
            <p className="text-[10px] text-muted-foreground/60 max-w-sm mx-auto leading-relaxed">
              Missions are posted by clan leaders or generated by the AI engine.
              Try adjusting your filters, or use the Generate button to create a personalized mission based on live world conditions.
            </p>
          </div>
        </DataCard>
      ) : (
