    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      <div className="flex items-start justify-between flex-wrap gap-2">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="shrink-0 w-[3px] h-8 bg-gradient-to-b from-primary via-primary/60 to-transparent" />
          <div className="min-w-0">
            ...
            {subtitle && (
              <p className="text-[11px] text-muted-foreground/80 font-mono mt-0.5 line-clamp-2 tracking-wide">{subtitle}</p>
            )}
          </div>
          {syncMeta && (
            <LiveSyncBadge
