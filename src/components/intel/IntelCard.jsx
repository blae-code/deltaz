...
const categoryConfig = {
  rumor: { icon: Radio, color: "text-muted-foreground", bg: "bg-secondary/50 border-border" },
  ...
  world_event: { icon: AlertTriangle, color: "text-foreground", bg: "bg-secondary/50 border-border" },
