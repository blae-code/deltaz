    ...
    <div className="border border-border rounded-sm p-3 bg-card space-y-2">
      ...
      {mode === "contested" && (
        <div className="space-y-1.5">
          <LegendItem color="rgba(45, 212, 160, 0.4)" border="rgba(45, 212, 160, 0.7)" label="SECURED" />
      ...
      {mode === "density" && (
        <div className="space-y-1.5">
          ...
          <div className="flex gap-1 items-center">
            <div className="h-3 flex-1 rounded-sm" style={{ background: "linear-gradient(to right, rgba(255,255,255,0.05), rgba(45,212,160,0.6))" }} />
          </div>
      ...
      {mode === "frontline" && (
        <div className="space-y-1.5">
          <LegendItem color="rgba(45, 212, 160, 0.3)" border="rgba(45, 212, 160, 0.6)" label="STABLE" />
