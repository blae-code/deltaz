      ...
      <div className="panel-frame w-full max-w-md p-0 overflow-hidden">
        ...
        <div className="px-6 py-8 space-y-6 text-center">
          ...
          <div className="flex justify-center">
            <div className="h-14 w-14 border border-border/60 bg-secondary/30 flex items-center justify-center relative">
              {/* Chamfer corner decoration */}
              <div className="absolute top-0 right-0 w-0 h-0 border-t-[10px] border-r-[10px] border-t-border/60 border-r-transparent" />
          ...
          <div className="space-y-1">
            <div className="text-[9px] font-mono text-status-danger/70 tracking-[0.35em] uppercase">
              ACCESS RESTRICTED
            </div>
          ...
          {/* Message */}
          <div className="bg-secondary/20 border border-border/40 px-4 py-3 text-left space-y-1.5">
          ...
          {/* Bottom tag */}
          <div className="text-[8px] font-mono text-muted-foreground/25 tracking-[0.25em] uppercase">
